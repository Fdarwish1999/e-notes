...
$crr_date=date('m/d/Y');
	 $sql="insert into upld_notes (note_title,note_file_name,upld_date)values
	(
		'".$_REQUEST['title']."',
		'". $newfilename."',
		'". $crr_date."'
  ...
  <div class="body">
    <div class="body_resize">
      <div class="left"> <img src="../images/img_1.jpg" alt="" width="84" height="90" />
        ...
        <tr>
          <td><div align="center" class="style8"><span class="style3">Notes Title </span></div></td>
          <td><div align="center" class="style8"><span class="style3"><input type="text" name="title" /></span></div></td>
        </tr>
		 <tr>
          <td><div align="center" class="style8"><span class="style3">Upload Notes </span></div></td>
